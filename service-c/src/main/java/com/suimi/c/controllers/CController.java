 ...
 */
package com.suimi.c.controllers;
...
import com.suimi.c.exception.AException;
import com.suimi.c.exception.AException.ErrorMsg;
import com.suimi.c.feign.BService;
...
@Api(value = "Cservice", description = "A服务类")
@Slf4j
@RefreshScope
